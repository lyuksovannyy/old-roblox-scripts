...
local Head = "RedBeanieWithHair" --press f9 and find the hat that looks like a heads name and put it here
...
local Hats = {rightarm = Character:WaitForChild("Robloxclassicred"),
                ...
                torso1   = Character:WaitForChild("HairAccessory"),
                but1   = Character:WaitForChild("International Fedora"),
                but2   = Character:WaitForChild("MeshPartAccessory"),
                bob1   = Character:WaitForChild("BrownCharmerHair"),
                bob2   = Character:WaitForChild("MessyHair"),
